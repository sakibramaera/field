...
const salesman_resolver_1 = require("./salesman.resolver");
let SalesmanModule = class SalesmanModule {
};
SalesmanModule = __decorate([
    (0, common_1.Module)({
        providers: [salesman_resolver_1.SalesmanResolver, salesman_service_1.SalesmanService]
    })
], SalesmanModule);

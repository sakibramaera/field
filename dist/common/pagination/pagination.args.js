...
let PaginationArgs = class PaginationArgs {
    static _GRAPHQL_METADATA_FACTORY() {
        return { skip: { nullable: true, type: () => Number }, after: { nullable: true, type: () => String }, before: { nullable: true, type: () => String }, first: { nullable: true, type: () => Number }, last: { nullable: true, type: () => Number } };
    }
};
